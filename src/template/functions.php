 ...
 */
 ...
 function reaction_count($post_id) {
    ...
    $reaction_order = $wpdb->get_results("SELECT meta_key, meta_value FROM $table where meta_key like '_reaction_buttons%' and post_id = " . $post_id . " order by CAST(meta_value as INTEGER) desc" );
